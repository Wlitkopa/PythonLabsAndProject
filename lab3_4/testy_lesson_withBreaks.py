...
class Test_TestAll(unittest.TestCase):
    ...
    term5 = Term(Day.MON, 16, 10, 10)
    term6 = Term(Day.MON, 17, 50, 10)
    term7 = Term(Day.MON, 19, 30, 10)
    term8 = Term(Day.MON, 11, 30, 10)
    term9 = Term(Day.MON, 16, 20, 10)
    ...
    def test_put(self): # SKORO DODAJĘ LEKCJE Z WYKORZYSTANIEM METODY "put", TO ZNACZY ŻE DZIAŁA JEŻELI CHODZI O POMYŚLNE DODAWANIE
        ...
        lesson_temp1 = Lesson(timetable, term2, "Fizyka", "dr Lewińska", 2)
        term3 = Term(Day.MON, 18, 20)
        lesson_temp2 = Lesson(timetable, term3, "Prog skryp - wykl", "dr Stanisław Polak", 2)
        print("lesson_temp2: ", lesson_temp2)
    ...
    def test_skipBreaks_True(self):
        ...
        self.assertEqual(lesson2.laterTime(), True)  # earlierTime pomija wszystkie przerwy później, zatem lekcja wyląduje nie o 11:20 tylko dopiero o 13:00
